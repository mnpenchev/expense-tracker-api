...
from rest_framework_simplejwt.tokens import RefreshToken  # https://django-rest-framework-simplejwt.readthedocs.io/en/latest/getting_started.html
...
class RegisterView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        data = {'to_email': user.email, 'email_body': email_body,
                'email_subject': 'User account verification'}
